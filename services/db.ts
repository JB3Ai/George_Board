...
const toRow = (item: ClipboardItem) => ({
  ...
  visible_in_tabs: item.visibleInTabs ?? null,
  is_demo: item.isDemo ?? false,
  board_id: item.boardId ?? null,
  board_position: item.boardPosition ?? null,
...
const fromRow = (row: any): ClipboardItem => ({
  ...
  visibleInTabs: row.visible_in_tabs ?? undefined,
  isDemo: row.is_demo ?? undefined,
  boardId: row.board_id ?? undefined,
  boardPosition: row.board_position ?? undefined,
