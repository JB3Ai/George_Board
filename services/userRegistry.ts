...
const SEED_USERS: RegisteredUser[] = [
  ...
  { id: 'SUE', label: 'SUE', email: 'sueblackburn@absamail.co.za', addedAt: 0 },
  { id: 'BARTHO', label: 'BARTHO', email: 'berasmus@gmail.com', addedAt: 0 },
  { id: 'GEORGE', label: 'GEORGE', email: 'gsourlis@yahoo.com', addedAt: 0 },
  { id: 'TAMMY', label: 'TAMMY', email: 'tammy.hughes1@gmail.com', addedAt: 0 },
  { id: 'CANDICE', label: 'CANDICE', email: 'candice.017@icloud.com', addedAt: 0 },
  { id: 'RADKIN', label: 'RADKIN', email: 'jonathantimothyrankin@gmail.com', addedAt: 0 },
  { id: 'STEPHAN', label: 'STEPHAN', email: 'stephan@ppisolutions.co.za', addedAt: 0 },
  { id: 'MUSSA', label: 'MUSSA', email: 'moussa@eaglestar.co.za', addedAt: 0 },
  { id: 'JASON', label: 'JASON', email: 'jason@computech-solutions.co.za', addedAt: 0 },
  { id: 'NICOLETTE', label: 'NICOLETTE', email: 'nicolettelongueira6@gmail.com', addedAt: 0 },
  { id: 'TRACY', label: 'TRACY', email: 'tracy.trace.1981@gmail.com', addedAt: 0 },
  { id: 'TEST', label: 'TEST', email: 'jonoelite@gmail.com', addedAt: 0 },
  { id: 'DONNA', label: 'DONNA', email: 'donnajadeblackburn@icloud.com', addedAt: 0 },
  { id: 'MARCIO', label: 'MARCIO', email: 'marcio.ds.maia@gmail.com', addedAt: 0 },
  { id: 'WAYNE', label: 'WAYNE', email: 'wayne@develcocorp.com', addedAt: 0 },
  { id: 'SAMANTHA', label: 'SAMANTHA', email: 'sambookings@hotmail.co.uk', addedAt: 0 },
  { id: 'RAYNE', label: 'RAYNE', email: 'mcleod.rayne7@gmail.com', addedAt: 0 },
];
